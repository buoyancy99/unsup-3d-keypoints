from environments.locomotion.robot_bases import MJCFBasedRobot, BodyPart
import numpy as np
...
class WalkerBase(MJCFBasedRobot):
    ...
    def calc_state(self):
        ...
        self.body_xyz = parts_xyz[3:6]  # torso z is more informative than mean z
...
class AntNocolor(WalkerBase):
    foot_list = ['front_left_foot', 'front_right_foot', 'left_back_foot', 'right_back_foot']

    def __init__(self):
        WalkerBase.__init__(self, "ant_nocolor.xml", "torso", action_dim=8, obs_dim=28, power=2.5)
